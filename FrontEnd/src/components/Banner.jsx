...
import aditya from "../../public/rename.png";
...
function banner() {
  ...
  <div className="max-w-screen-2xl order-2 container max-auto md:px-20 px-4 flex flex-col md:flex-row my-10 ">
    <div class="w-full order-2 md:order-1 md:w-1/2 mt:12  md:mt-32">
      ...
      <p className='text-xl'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus voluptates porro cum natus labore, nam ipsa hic placeat molestias assumenda?
      </p>
...
<button className="mt-6 btn btn-secondary">Secondary</button>
    ...
    <div class=" w-full order-1 md:w-1/2 ">
      <img src={aditya} className='w-90 h-90'/>
      </div>
  </div>
  </>
}
